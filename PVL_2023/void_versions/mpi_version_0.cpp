...
int main(int argc, char** argv) {
   ...
   // Initilialize Local grid and immune period
    ...
    for (int step = 0; step < steps; ++step) {
        ...
        //     std::cout << "Step " << step << ":\n";
        //     for (int i = 0; i < flat_gathered_grid.size(); ++i) {
        //         outfile << flat_gathered_grid[i];
        //         // if ((i + 1) % grid_size == 0)
        //         //     outfile << "\n";
        //         // else
        //         //     outfile << " ";
        //     }
        //     //outfile << "\n"; // Separate steps by an extra newline if desired
        // }
        ...
        // if (step % 100 == 0) {
        //     MPI_Gatherv(
        //         flat_local_grid.data(), flat_local_grid.size(), MPI_INT,
        //         (rank == 0) ? flat_gathered_grid.data() : nullptr,
